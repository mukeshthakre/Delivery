   ...
   <form method="POST">
    ...
    <h3> Select Your Product Categories</h3>
      <select class="select-box" name="pack_typ" required>
        <option > </option>
        <option value="Apperel & accessories" name="p">Apperel & accessories</option>
        <option value="Automotives" name="p">Automotives</option>
        <option value="Baby Care" name="p">Baby Care</option>
        <option value="Books & Stationery" name="p">Books & Stationery</option>
        <option value="Documents" name="p">Documents</option>
        <option value="Computer & Accessories" name="p">Computer & Accessories</option>
        <option value="Electronics" name="p">Electronics</option>
        <option value="Household Items" name="p">Household Items</option>
        <option value="Sport Equipments" name="p">Sport Equipments</option>
        <option value="Beuty Products" name="p">Beuty Products</option>
      </select><br/><br/>
