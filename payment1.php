   ...
   $accept = $_POST['pay'];
        ...
        if(strlen($cardno)== 16 && strlen($cvvno)== 3 )
        {
          ...
          while ($row1 = mysqli_fetch_array($result))
           ...
           $subject='Your Package will send Successfully';
            ...
            $message='Thanks '.$name .', for sending your Package. You have done card payment, your package will be receive on  '.$next_date. '.'.' '.
           ...
           $headers = 'From: mukeshthakrebabai@gmail.com' . "\r\n" .
            ...
            $admin='mukeshcollegework@gmail.com';
            $adminsub='User has Sent Package Successfully';
            $adminmsg='User has Sent Package Successfully. User Id is '.$user_idd. 'And name -'.$fname.
                                 'User has done Card payment. User package tracking id is'.$$randNumber.'.';

            mail($admin, $adminsub, $adminmsg, $headers);
      ...
      {  
          ...
          $headers = 'From: mukeshthakrebabai@gmail.com' . "\r\n" .
            ...
            $adminsub='User has Sent Package Successfully';
            $adminmsg='User has Sent Package Successfully. User Id is '.$user_idd. 'And name -'.$fname.
                                 'User has done UPI payment. User package tracking id is'.$$randNumber.'.';
      ...
      {   
         ...
         while ($row1 = mysqli_fetch_array($result))
          ...
          $headers = 'From: mukeshthakrebabai@gmail.com' . "\r\n" .
            ...
            $adminsub='User has Sent Package Successfully';
            $adminmsg='User has Sent Package Successfully. User Id is '.$user_idd. 'And name -'.$fname.
                                 'User has done Cash On Delivery payment. User package tracking id is'.$$randNumber.'.';
           ...
           <div class="input-group">
            ...
            <div class="input-group">
                ...
                <div class="input-box">
                    ...
                    <input type="Text" placeholder="" name="cashon" class="name2" value="<?php if(isset($pack_size)){echo"".$c;} ?>" id="card2" readonly>
                  </div>
                  
                </div>
                <h2>Your Total charges is <b><?php if(isset($pack_size)){echo"".$c=$_SESSION['charge'];} ?></b></h2>
            <div class="input-group">
                <div class="input-box">
